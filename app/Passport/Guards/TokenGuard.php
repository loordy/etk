...
use App\Passport\TransientToken;
...
class TokenGuard
{
     ...
     *
     * @var \App\Passport\ClientRepository
     */
    protected $clients;
     ...
     * @param  \App\Passport\ClientRepository  $clients
    ...
    protected function authenticateViaBearerToken($request)
    {
        ...
        try {
            ...
            $token = $this->tokens->find( $psr->getAttribute('oauth_client_id'),
